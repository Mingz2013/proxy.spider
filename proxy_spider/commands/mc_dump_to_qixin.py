...
from proxy_spider.proxy.proxy import DumpProxyItemsValidToProxyItemsQixin
...
class Command(ScrapyCommand):
    ...
    def run(self, args, opts):
        try:
            ...
            dump_to_qixin = DumpProxyItemsValidToProxyItemsQixin()
            dump_to_qixin.start_threadpool()
